...
import type { Repository } from "../hooks/use-repos";
...
interface ProviderCardProps {
  ...
  onDisconnect: () => void;
  onImport: (repo: Repository, branch: string) => void;
  isImporting?: boolean;
}
...
export function ProviderCard({
  ...
  const handleConnect = () => {
    ...
    window.location.href = `/api/git/connect/${provider}?workspace=${workspaceSlug}`;
  };

  const handleImport = () => {
    if (selectedRepo && selectedBranch) {
      onImport(selectedRepo, selectedBranch);
    }
  };
